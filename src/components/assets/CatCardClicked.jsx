const CatCardClicked = (props) => {
  return (
    <div className={"cat-details z-20 static top-20 left-auto m-0 w-min h-min fixed flex self-start justify-self-start flex-col border-8 border-secondary-white rounded-lg transition-all duration-300 opacity-100"}>
