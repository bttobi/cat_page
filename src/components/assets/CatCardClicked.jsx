const CatCardClicked = (props) => {
  return (
    <div className="cat-details z-20 m-0 fixed top-0 flex flex-col rounded-lg transition-all duration-300 opacity-100" style={{minWidth:"40vw", maxWidth: "70vw"}}>
      <div className="flex flex-col flex-grow cat-description-wrapper p-2 bg-primary rounded-lg shadow-lg shadow-black"  style={{background: "rgba(0, 0, 0, .65) " + `url(${props.cat.url})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundBlendMode: "darken"}}>
        ...
        <>
          ...
          <div className="button wrapper flex flex-col justify-center align-center items-center">
