const CatCardClicked = (props) => {
  return (
    <div className={"cat-details z-20 left-auto m-0 w-min h-min fixed flex flex-grow self-start justify-self-start flex-col border-4 border-secondary-white rounded-lg transition-all duration-300 opacity-100"}>
      <div className="cat-description-wrapper w-full h-full p-2 bg-primary">
        <button className="close-button btn btn-sm btn-square bg-primary right-0 mr-2 btn-outline absolute m-1 transition-all duration-150 hover:scale-110" onClick={(e, isShown) => {props.func(e, true);}}>
