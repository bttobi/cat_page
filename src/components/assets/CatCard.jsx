...
const CatCard = (props) => {
  return (
    <div className="cat-wrapper w-min h-min m-4 flex flex-col border-8 border-secondary-white rounded-lg transition-all duration-300 hover:scale-110">
        <div className="favourite py-6 pl-6 pr-2 w-full h-8 flex flex-row justify-end items-center">
          <button className="align-end w-min h-min transition-all duration-200 hover:scale-125">❤️</button>
        </div>
