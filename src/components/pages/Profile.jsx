...
const Profile = () => {
  ...
  return (
    <motion.div initial={{scaleY: 0}} animate={{scaleY: 1}} exit={{scaleY: 0}} className="font-article text-white w-full h-full mt-32 flex flex-col text-lg font-bold justify-center align-center items-center">
