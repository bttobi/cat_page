...
const CatBreeds = () => {
  ...
  return (
      <motion.div id="cat-breeds" initial={{scaleY: 0}} animate={{scaleY: 1}} exit={{scaleY: 0}} className="home-page w-full h-full m-none mt-16  flex flex-col justify-start items-center font-article text-white">
        <AnimatePresence>
