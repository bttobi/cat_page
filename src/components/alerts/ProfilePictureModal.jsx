    ...
    <>
      ...
      <label htmlFor="prof-pic" className="modal cursor-pointer font-article text-white">
        <label className="modal-box relative bg-dark flex flex-col justify-center align-center shadow-md shadow-black" htmlFor="">
          <label htmlFor="prof-pic" className="close-button btn btn-sm btn-error btn-square bg-primary right-0 top-0 mt-2 mr-2 btn-outline fixed transition-all duration-150 hover:scale-110">
          ...
          <div className="wrapper flex flex-col justify-center align-center items-center">
            ...
            <AnimatePresence>
              ...
              <motion.div className="flex flex-col justify-center items-center" initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} >
                <div className="w-48 h-48 rounded-lg mt-4 border-white border-2" style={{backgroundImage: `url(${userPicture})`, backgroundSize: "cover", backgroundPosition: "center"}} />
                ...
                <a className="btn h-min text-center mt-8 text-white bg-green-500 hover:bg-green-700 border-0" href={userPicture} target="_blank">SEE PROFILE PIC IN FULLSCREEN</a>
              </motion.div>: 
              <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className="w-48 h-48 rounded-lg text-lg border-white border-2 p-3 flex justify-center align-center items-center text-center mt-4">Profile picture removed!</motion.div>}
            </AnimatePresence>
          </div>
        </label>
      <AnimatePresence>
